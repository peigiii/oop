...
<body>
    <div class="container">
        <header>
            <h1>🎨 Design Skill Test</h1>
            <div class="grid-container">
                <div class="level-card">
                    <h3>Design</h3>
                    <p>Level 1</p>
                    <button onclick="startQuiz('design_level_1')">Start Quiz</button>
                </div>
                <div class="level-card">
                    <h3>Design</h3>
                    <p>Level 2</p>
                    <button onclick="startQuiz('design_level_2')">Start Quiz</button>
                </div>
                <div class="level-card">
                    <h3>Design</h3>
                    <p>Level 3</p>
                    <button onclick="startQuiz('design_level_3')">Start Quiz</button>
                </div>
            </div>
        </header>
    </div>
