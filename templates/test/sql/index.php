...
<body>
    <div class="container">
        <header>
            <h1>🗄️ SQL Skill Test</h1>
            <div class="grid-container">
                <div class="level-card">
                    <h3>SQL</h3>
                    <p>Level 1</p>
                    <button onclick="startQuiz('sql_level_1')">Start Quiz</button>
                </div>
                <div class="level-card">
                    <h3>SQL</h3>
                    <p>Level 2</p>
                    <button onclick="startQuiz('sql_level_2')">Start Quiz</button>
                </div>
                <div class="level-card">
                    <h3>SQL</h3>
                    <p>Level 3</p>
                    <button onclick="startQuiz('sql_level_3')">Start Quiz</button>
                </div>
            </div>
        </header>
    </div>
