...
<head>
    ...
    <title>Editing & PS Skill Test</title>
...
<body>
    <div class="container">
        <header>
            <h1>🧠 Editing & PS Skill Test</h1>
            <div class="grid-container">
                <div class="level-card">
                    <h3>Editing & PS</h3>
                    <p>Level 1</p>
                    <button onclick="startQuiz('editing_ps_level_1')">Start Quiz</button>
                </div>
                <div class="level-card">
                    <h3>Editing & PS</h3>
                    <p>Level 2</p>
                    <button onclick="startQuiz('editing_ps_level_2')">Start Quiz</button>
                </div>
                <div class="level-card">
                    <h3>Editing & PS</h3>
                    <p>Level 3</p>
                    <button onclick="startQuiz('editing_ps_level_3')">Start Quiz</button>
                </div>
            </div>
        </header>
    </div>
