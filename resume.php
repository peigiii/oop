...
<body>
  ...
  <div class="form-container">
    ...
    <div class="form-group">
      ...
      <input type="text" id="position" placeholder="e.g. Digital Content Marketer">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" id="skills" placeholder="e.g. Content Strategy, SEO, Social Media">
    </div>
    <div class="form-group">
      <label for="profilePicInput">Upload Profile Picture</label>
      <input type="file" id="profilePicInput" accept="image/*">
    </div>
    <button id="generateBtn" class="btn">Generate Resume</button>
  </div>
  ...
  <div class="resume-container" id="resumePreview">
    ...
    <div class="left-column">
      <div class="profile-pic" id="profilePic">
        <!-- Uploaded profile picture will appear here -->
      </div>
      <!-- Contact Info -->
